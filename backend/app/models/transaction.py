...
class Transaction(Base):
    ...
    # Both legs of an account-to-account transfer share a transfer_group and are
    # flagged so they're excluded from income/expense analytics.
    is_transfer: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    transfer_group: Mapped[Optional[str]] = mapped_column(String(40), nullable=True, index=True)
